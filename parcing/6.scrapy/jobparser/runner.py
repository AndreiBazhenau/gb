# I вариант: 1) Доработать паука в имеющемся проекте, чтобы он формировал item по структуре:
# *Наименование вакансии, *Зарплата от, *Зарплата до, *Ссылку на саму вакансию, *Сайт откуда собрана вакансия
